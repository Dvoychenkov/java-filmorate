...
CREATE TABLE IF NOT EXISTS PUBLIC.FILMS_DIRECTORS (
	...
	CONSTRAINT FILMS_DIRECTORS_FILMS_FK FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS(ID),
	CONSTRAINT FILMS_DIRECTORS_DIRECTORS_FK FOREIGN KEY (DIRECTOR_ID) REFERENCES PUBLIC.DIRECTORS(ID)
);